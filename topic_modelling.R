...
plan2020_text <- readtext("~/R Projects/stf_text_mining/planilha2020_processada-dupl_clusters.csv", text_field = "acordao")  # Indicates the column with the full extent of the judicial opinion as the text field.
